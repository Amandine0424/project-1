# -*- coding: utf-8 -*-
"""Spaceship_version_escape_room.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/Amandine0424/project-1/blob/main/Spaceship_version_escape_room.ipynb
"""

!pip install pygame

"""<a href="https://colab.research.google.com/github/Amandine0424/project-1/blob/main/Spaceship_version_escape_room.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>"""
...
all_rooms = [navigation_room, cabine_1, cabine_2, control_room, airlock_chamber, outside]

all_doors = [door_a, door_b, door_c, door_d]

object_relations = {
    "navigation room": [couch, control_panel, desk, chair, door_a], #Irina: new furniture added
    "cabine 1": [bunk_bed, armchair, shelf, door_c, door_b], #Irina: new furniture added
    "cabine 2": [double_bed, chest_of_drawers, dresser, door_b], #Irina: new furniture added
    ...
    "dresser": [key_d],
    "double bed": [key_c],
    "door a": [navigation_room, cabine_1],
    "door b": [cabine_1, cabine_2],
    "door c": [cabine_1, control_room],
            ...
            if item["type"] == "door":
                ...
                if item["name"] in object_relations and len(object_relations[item["name"]]) > 0:
                    ...
                    if item_found["name"] == "key for door a":
                        if ask_questions():
                            output += "You answered the questions correctly and earned the key for door D, and you are now in the last room."
...
def ask_questions():
    print("Yay! You have found the key for door A. If you get the next two questions right, you'll advance to the last room and you'll be able to use your key for door D. Oh and one more thing... Make sure you make the right choice in the airlock chamber ;).")
...
def left_or_right():
    print("You're now out of the control room and in the airlock chamber connected to outside, you have to choose to turn left or right. Choosing wrong side will lead you back to the game room")
